from anomaly_detection.tasks.sample_etl_task import SampleETLTask
from anomaly_detection.tasks.sample_ml_task import SampleMLTask
...
def test_jobs(spark: SparkSession, tmp_path: Path):
    ...
    test_ml_config = {
        "input": common_config,
        "experiment": "/Shared/Anomaly_detection/sample_experiment"
    }
