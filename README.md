...
```
This command will create your personal repository under `/Repos/<username>/anomaly_detection`.
...
- To trigger the release pipeline, get the current version from the `anomaly_detection/__init__.py` file and tag the current code version:
```
